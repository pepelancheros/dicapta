<template>
  <main id="main" class="privacy-policy">
    ...
    <div class="privacy-policy__content">
      ...
      <p>
        This Privacy Policy governs the manner in which Closed Caption Latina
        Corporation collects, uses, maintains and discloses information
        collected from users (each, a "User") of the http://www.dicapta.com
        website ("Site").
      </p>
      ...
      <p>
        Closed Caption Latina Corporation may collect and use Users personal
      ...
      <p>
        Closed Caption Latina Corporation has the discretion to update this
        privacy policy at any time. When we do, we will post a notification on
        the main page of our Site, revise the updated date at the bottom of this
      ...
      <p>
        ...
        deemed your acceptance of those changes. This privacy policy was built
        using the generator at
        <a
          href="https://PrivacyPolicies.com"
          target="_blank"
          rel="noopener noreferrer"
          >https://privacypolicies.com</a
        >.
      </p>
      <h2>Contacting us</h2>
      <p>
